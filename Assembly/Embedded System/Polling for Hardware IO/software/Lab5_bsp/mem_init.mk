...
# Memory: On_Chip_Mem
MEM_0 := QsysSystem_On_Chip_Mem
$(MEM_0)_NAME := On_Chip_Mem
...
$(MEM_0)_HIERARCHICAL_PATH := On_Chip_Mem
$(MEM_0)_WIDTH := 32
...
.PHONY: On_Chip_Mem
On_Chip_Mem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
