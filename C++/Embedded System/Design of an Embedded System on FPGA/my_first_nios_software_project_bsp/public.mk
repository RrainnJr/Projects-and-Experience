...
SOPCINFO_FILE := C:/intelFPGA_lite/16.1/Lab3/QsysSystem.sopcinfo
...
# Design Name 
# setting SOPC_NAME is QsysSystem
SOPC_NAME := QsysSystem
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x2058
SOPC_SYSID_FLAG += --sidp=0x2058
ELF_PATCH_FLAG  += --sidp 0x2058

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1664056381
SOPC_SYSID_FLAG += --timestamp=1664056381
ELF_PATCH_FLAG  += --timestamp 1664056381
